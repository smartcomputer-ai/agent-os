...
fn decode_host_fs_write_file_params(bytes: &[u8]) -> anyhow::Result<HostFsWriteFileParams> {
...
fn decode_host_fs_apply_patch_params(bytes: &[u8]) -> anyhow::Result<HostFsApplyPatchParams> {
