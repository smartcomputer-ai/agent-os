use crate::{
    ActiveToolBatch, ActiveWindowItem, ActiveWindowItemKind, CauseRef, CompactionArtifactKind,
    CompactionRecord, CompactionStrategy, ContextMetadataEntry, ContextOperationPhase,
    ContextOperationState, ContextPressureReason, ContextPressureRecord, ContextState, HostCommand,
    HostMountConfig, HostSessionOpenConfig, HostSessionStatus, HostTargetConfig, LlmUsageRecord,
    PendingBlobGet, PendingBlobGetKind, PendingBlobPut, PendingBlobPutKind, PlannedToolCall,
    PlannerStateRef, ProviderCompatibility, QueuedRunStart, ReasoningEffort, RunCause,
    RunCauseOrigin, RunConfig, RunFailure, RunId, RunInterrupt, RunLifecycle, RunLifecycleChanged,
    RunOutcome, RunRecord, RunState, RunTrace, RunTraceEntry, RunTraceEntryKind, RunTraceRef,
    RunTraceSummary, SessionConfig, SessionId, SessionInput, SessionInputKind, SessionLifecycle,
    SessionLifecycleChanged, SessionNoop, SessionState, SessionStatus, SessionStatusChanged,
    SessionTurnState, SessionWorkflow, SessionWorkflowEvent, SharedPendingBlobGet,
    SharedPendingBlobPut, StagedToolFollowUpTurn, ToolBatchId, ToolBatchPlan, ToolCallLlmResult,
    ToolCallObserved, ToolCallStatus, ToolExecutionPlan, ToolExecutor, ToolMapper,
    ToolOverrideScope, ToolParallelismHint, ToolRuntimeContext, ToolSpec, TranscriptLedger,
    TranscriptLedgerEntry, TranscriptLedgerEntryKind, TranscriptRange, TurnBudget, TurnInput,
    TurnInputKind, TurnInputLane, TurnObservation, TurnPlan, TurnPrerequisite,
...
aos_wasm_sdk::aos_air_world! {
    pub fn aos_air_nodes() {
        ...
        schemas: [
            ...
            ActiveWindowItemKind,
            ContextMetadataEntry,
            ActiveWindowItem,
            TranscriptLedgerEntryKind,
            TranscriptLedgerEntry,
            TranscriptLedger,
            CompactionStrategy,
            CompactionArtifactKind,
            ContextPressureReason,
            ContextPressureRecord,
            ContextOperationPhase,
