...
impl WorldConfig {
    ...
    fn from_env_values(
        ...
        strict_op_routes: Option<String>,
...
mod tests {
    ...
    #[test]
    fn world_config_from_env_enables_strict_op_routes() {
        let cfg = WorldConfig::from_env_values(None, None, Some("true".into()), None, None);
        assert!(cfg.strict_op_routes);
    }
