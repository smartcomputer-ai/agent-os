...
use crate::protocol::{
    ...
    SegmentIndexRecord, UniverseId, WorldId,
};

pub fn segment_object_key(universe: UniverseId, world: WorldId, segment: SegmentId) -> String {
    format!(
        "segments/{universe}/{world}/{}-{}.log",
...
mod tests {
    ...
    fn segment_codec_round_trips() {
        ...
        let record = SegmentIndexRecord {
            segment,
            object_key: segment_object_key(Uuid::nil().into(), Uuid::nil().into(), segment),
