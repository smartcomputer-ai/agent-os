...
aos_workflow!(LlmSummarizerSm);

#[derive(Default)]
struct LlmSummarizerSm;

impl Workflow for LlmSummarizerSm {
...
fn handle_start(ctx: &mut WorkflowCtx<SummarizerState, ()>, url: String) {
...
fn handle_receipt(
    ctx: &mut WorkflowCtx<SummarizerState, ()>,
