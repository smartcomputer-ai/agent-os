...
use aos_effects::builtins::{
    HostExecParams, HostExecReceipt, HostFsApplyPatchParams, HostFsApplyPatchReceipt,
    ...
    HostFsStatReceipt, HostFsWriteFileParams, HostFsWriteFileReceipt, HostOutput,
...
use super::super::traits::AsyncEffectAdapter;
use super::output::{
...
use super::paths::{
    PathResolveError, display_relative, resolve_session_base, resolve_session_path,
};
use super::shared::{
...
impl AsyncEffectAdapter for HostSessionOpenAdapter {
    ...
    async fn run_terminal(&self, intent: &EffectIntent) -> anyhow::Result<EffectReceipt> {
        ...
        let Some(target_local) = params.target.as_local() else {
            let payload = HostSessionOpenReceipt {
                session_id: String::new(),
                status: "error".into(),
                started_at_ns,
...
mod tests {
    ...
    use aos_effects::builtins::{
        HostFileContentInput, HostFsReadFileParams, HostFsWriteFileParams, HostLocalTarget,
        HostTarget,
    };
