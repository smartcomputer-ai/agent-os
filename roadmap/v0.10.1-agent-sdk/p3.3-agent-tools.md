...
4. Kept workspace tool catalogs convention-first:
   - `tools/catalogs/<catalog>.json`.
5. Added reducer/helper/smoke coverage for direct tool refs without workspace binding.
...
2. Optional composed parent `core_workspace_sync@2` remains a follow-up composition step.
