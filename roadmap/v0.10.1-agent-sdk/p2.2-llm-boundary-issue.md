...
Status note (2026-02-14): consolidated integration assertions are in place across `aos-agent-sdk` mapper tests, `aos-host` adapter request-path integration tests, and `aos-smoke` deterministic replay coverage.
