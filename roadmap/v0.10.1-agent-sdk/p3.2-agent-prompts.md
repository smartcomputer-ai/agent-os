...
3. Export prompt-only workspace sync now; keep monolithic `core_workspace_sync@1`
   as a compatible composed path until optional `core_workspace_sync@2` lands.
...
1. Full prompt+tool composed parent refactor (`core_workspace_sync@2`) remains optional and
   tracked with p3.3/p3.4 planning.
