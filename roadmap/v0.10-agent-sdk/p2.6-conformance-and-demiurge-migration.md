...
3. Migrate Demiurge core flow to SDK contracts:
   - `demiurge/*` to `aos.agent/*` mapping,
   - keep short-term adapters only where needed.
4. Ship at least one reusable sample world for parent/child orchestration.
...
1. Conformance test harness under SDK/host integration tests.
