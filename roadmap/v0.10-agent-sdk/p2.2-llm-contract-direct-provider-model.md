...
**Stage**: P2.2  
**Status**: In Progress (mapper + replay slice landed)  
**Depends on**: P2.1
...
1. Add/confirm deterministic integration coverage focused on full P2.2 acceptance criteria (provider paths, runtime refs, receipt envelope fields).
2. Close any remaining P2.2-specific conformance assertions across cap enforcer/runtime tests.
...
Status note (2026-02-13): Deliverable #4 is now implemented in `aos-agent-sdk`; remaining work is convergence of full acceptance-criteria coverage across integration and conformance tests.
