...
**Date**: 2026-02-13  
**Status**: Accepted; roadmap rebaseline applied on 2026-02-13 (cleanup complete, mapper + deterministic session boundary slice landed)
...
Status note (2026-02-13): SDK mapper helpers, mapper unit assertions (including optional runtime fields), and expanded session smoke replay coverage are in place. A consolidated integration assertion set for all three bullets above remains open.
