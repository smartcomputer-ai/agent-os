...
This allows deterministic incrementing in reducer state and avoids cross-host UUID generation concerns.
    ...
    "record": {
      ...
      "command": {
        "variant": {
          ...
          "Reconfigure": { "record": { "patch": { "bytes": {} } } },
          "Pause": { "unit": {} },
          "Resume": { "unit": {} },
...
```json
{
  ...
  "type": {
    "variant": {
      "RunRequested": { "record": { "input_ref": { "hash": {} } } },
      "RunStarted": { "unit": {} },
      "HostCommandReceived": { "ref": "aos.agent/HostCommand@1" },
      "HostCommandApplied": { "record": { "command_id": { "text": {} } } },
...
Given `session_id = "chat-42"`:

1. First input starts `run_id = {session_id:"chat-42", run_seq:1}`.
