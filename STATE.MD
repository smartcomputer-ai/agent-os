...
- **Current Gaps**:
  - FsJournal now backs the on-disk journal path; next step is to harden it with stress/fuzz tests for partial segments, truncation, and corruption handling plus corresponding repair tooling.
