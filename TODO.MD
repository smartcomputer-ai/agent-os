...
11. **[x] Example 04 — Aggregator (fan-out + join)** — Added AIR assets, reducer, shared HTTP harness, kernel fan-out support, runner, and CLI/tests for the aggregator fan-out demo.
