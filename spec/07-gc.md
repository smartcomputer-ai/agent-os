...
P1 introduces baseline snapshots as semantic restore roots, not only replay acceleration hints.
...
- retained snapshot roots (latest K, baseline set, or policy-defined set)
